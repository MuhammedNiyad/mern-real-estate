...
export const google = async (req, res, next) => {
    try {
        ...
        if(user) {
            ...
            const generatedPassword = Math.random().toString(36).slice(-8) + Math.random().toString(36).slice(-8);   /* This is for automaticaly generate password because we don't get password when we login with google...! */
